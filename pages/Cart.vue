<template>
  <section class="py-5 w-100">
    ...
    <div v-if="products.length === 0" class="row d-flex justify-content-center">
      <img src="@/assets/emptyCart.png" class="p-5 w-50 text-center" alt="">
    </div>
    <template v-else>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              ...
              <NuxtLink :to="{name: 'Payment'}">Proceed to Checkout</NuxtLink>
            </div>
          </div>
        </div>
      </div>
